...
<body>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a href="">Convenios</a>
            <ul>
              <li><a href="vistas/conveniosNacionales.php">Convenios Nacionales</a></li>              
              <li><a href="vistas/conveniosInternacionales.php">Convenios Internacionales</a></li>
            </ul>
          </li>
  ...
  <div class="jumbotron jumbotron-fluid">
        <div class="container-fluid">
            <h1 class="display-4">Convenios Internacionales</h1>
  ...
  <script src="../js/gestor.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tablaGestorArchivos').load("gestor/tablaGestorConveniosInternacionales.php");
